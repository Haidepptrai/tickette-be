...
namespace Tickette.Infrastructure.Migrations
{
    ...
    [Migration("20250415065459_Fix_Committee_Member_Table_Relationship")]
    partial class Fix_Committee_Member_Table_Relationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tickette.Domain.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Tickette.Domain.Entities.Coupon", b =>
                {
                    ...
                    b.Property<DateTime>("StartValidDate")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("start_valid_date");
            ...
            modelBuilder.Entity("Tickette.Domain.Entities.EmailUnsubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_email_unsubscriptions");

                    b.HasIndex("Email")
                        .IsUnique()
                        .HasDatabaseName("ix_email_unsubscriptions_email");

                    b.ToTable("email_unsubscriptions", (string)null);
                });
            ...
            modelBuilder.Entity("Tickette.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.Property<string>("SeatsOrdered")
                        .HasColumnType("jsonb")
                        .HasColumnName("seats_ordered");
            ...
            modelBuilder.Entity("Tickette.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.OwnsOne("Tickette.Domain.ValueObjects.Price", "Price", b1 =>
                        {
            ...
            modelBuilder.Entity("Tickette.Domain.Entities.ReservationItem", b =>
                {
                    b.HasOne("Tickette.Domain.Entities.Reservation", "Reservation")
                        .WithMany("Items")
