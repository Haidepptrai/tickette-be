...
namespace Tickette.Infrastructure.Migrations
{
    ...
    [Migration("20250201180814_Not_Required_Coupon_In_Order")]
    partial class Not_Required_Coupon_In_Order
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tickette.Domain.Entities.Cart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Tickette.Domain.Entities.CartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TicketId")
                        .HasDatabaseName("ix_cart_items_ticket_id");
            ...
            modelBuilder.Entity("Tickette.Domain.Entities.EventSeat", b =>
                {
                    ...
                    b.HasIndex("EventId")
                        .HasDatabaseName("ix_event_seats_event_id");
                    ...
                    b.HasIndex("Row", "Column", "EventId")
                        .IsUnique()
                        .HasDatabaseName("ix_event_seats_row_column_event_id");
            ...
            modelBuilder.Entity("Tickette.Domain.Entities.Cart", b =>
                {
                    b.HasOne("Tickette.Domain.Entities.User", "User")
                        .WithOne("Cart")
                        .HasForeignKey("Tickette.Domain.Entities.Cart", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Tickette.Domain.Entities.CartItem", b =>
                {
                    b.HasOne("Tickette.Domain.Entities.Cart", "Cart")
                        .WithMany("CartItems")
                    ...
                    b.HasOne("Tickette.Domain.Entities.Ticket", "Ticket")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_cart_items_tickets_ticket_id");
